...
Tasks >30 phút PHẢI có planning file với phases, tasks, và progress tracking.
...
- **Rule 1: State-Preserving <data_randomID>** Mọi luồng hoạt động phải được serialize (tuần tự hóa) call stack và broadcast trạng thái mỗi 100ms.
...
- **Rule 3: Autonomous Remote Discovery:** Trước khi thực hiện lệnh Git lần đầu trong phiên mới, Agent phải kiểm tra Metadata/Project Map. Nếu thấy `link.git` đã lưu, Agent tự động thiết lập `git remote add origin [link]` nếu chưa có.
