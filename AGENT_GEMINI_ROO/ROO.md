...
**Khi nào dùng:** Tasks >30 phút, multi-phase projects, complex refactoring.
**Khi nào KHÔNG cần:** Simple fixes (<10 phút), single-file changes, quick tests.

---

### RULE 6: EXTERNAL SKILL INTEGRATION (Tích hợp Skills Ngoài / sickn33)
