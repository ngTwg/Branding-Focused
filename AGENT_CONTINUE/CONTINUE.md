...
1. ĐỌC: {ANTIGRAVITY_ROOT}/skills/MASTER_ROUTER.md
...
1. LUÔN load {ANTIGRAVITY_ROOT}/skills/workflows/debug-protocol.md TRƯỚC
...
- Chi tiết kỹ thuật: `{ANTIGRAVITY_ROOT}/skills/deep-tech/autonomous-cognition-inventory.md` (Group 7 & 8)
