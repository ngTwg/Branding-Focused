...
tags: ["access", "antigravity", "azure", "c:", "client", "connection", "creation", "defaultazurecredential", "devops", "for", "frontend", "gemini", "installation", "java", "key", "<YOUR_USERNAME>", "messaging", "pubsub", "sdk", "string"]
tier: 3
risk: "medium"
