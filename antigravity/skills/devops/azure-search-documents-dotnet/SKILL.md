...
tags: ["antigravity", "api", "auth", "authentication", "azure", "c:", "client", "devops", "documents", "dotnet", "environment", "for", "frontend", "gemini", "installation", "key", "<YOUR_USERNAME>", "net", "not", "production"]
tier: 2
risk: "medium"
