...
tags: ["antigravity", "app", "appconfiguration", "authentication", "azure", "backend", "c:", "configuration", "connection", "devops", "entra", "environment", "for", "gemini", "installation", "<YOUR_USERNAME>", "py", "python", "sdk", "string"]
tier: 2
risk: "medium"
