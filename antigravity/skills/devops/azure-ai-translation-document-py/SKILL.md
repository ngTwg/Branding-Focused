...
tags: ["ai", "and", "antigravity", "api", "authentication", "azure", "backend", "c:", "devops", "document", "documents", "environment", "for", "gemini", "installation", "key", "<YOUR_USERNAME>", "py", "python", "sdk"]
tier: 3
risk: "medium"
