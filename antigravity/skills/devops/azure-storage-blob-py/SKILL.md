...
tags: ["antigravity", "authentication", "azure", "backend", "blob", "c:", "client", "devops", "environment", "for", "full", "gemini", "hierarchy", "installation", "<YOUR_USERNAME>", "py", "python", "sdk", "storage", "url"]
tier: 2
risk: "medium"
