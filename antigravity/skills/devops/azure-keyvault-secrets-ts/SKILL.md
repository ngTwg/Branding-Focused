...
tags: ["antigravity", "authentication", "azure", "backend", "c:", "devops", "environment", "for", "gemini", "installation", "key", "keyvault", "<YOUR_USERNAME>", "sdk", "secrets", "ts", "typescript", "users", "variables", "vault"]
tier: 2
risk: "medium"
