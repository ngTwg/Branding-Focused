...
tags: ["antigravity", "authentication", "azure", "backend", "c:", "core", "devops", "dotnet", "environment", "gemini", "hierarchy", "installation", "<YOUR_USERNAME>", "manager", "net", "postgresql", "resource", "resourcemanager", "users", "variables"]
tier: 2
risk: "medium"
