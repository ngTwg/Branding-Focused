...
tags: ["antigravity", "application", "azure", "c:", "code", "connection", "devops", "distro", "environment", "for", "from", "frontend", "gemini", "installation", "<YOUR_USERNAME>", "line", "monitor", "one", "opentelemetry", "py"]
tier: 2
risk: "medium"
