...
tags: ["ai", "antigravity", "api", "authentication", "azure", "c:", "devops", "dotnet", "entra", "environment", "frontend", "gemini", "installation", "key", "<YOUR_USERNAME>", "microsoft", "net", "not", "optional", "recommended"]
tier: 3
risk: "medium"
