...
tags: ["antigravity", "authentication", "azure", "c:", "client", "core", "cosmos", "devops", "environment", "for", "frontend", "gemini", "hierarchy", "installation", "<YOUR_USERNAME>", "py", "python", "sdk", "users", "variables"]
tier: 3
risk: "medium"
