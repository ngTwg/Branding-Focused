...
tags: ["active", "advanced", "antigravity", "attacks", "bloodhound", "c:", "contents", "delegation", "directory", "frontend", "gemini", "<YOUR_USERNAME>", "powershell", "reference", "references", "security", "table", "unconstrained", "users"]
tier: 2
risk: "critical"
