...
tags: ["antigravity", "basic", "c:", "cache", "data", "dev", "fetching", "first", "frontend", "gemini", "guidelines", "<YOUR_USERNAME>", "pattern", "patterns", "primary", "resources", "strategy", "usequery", "users", "usesuspensequery"]
tier: 2
risk: "medium"
