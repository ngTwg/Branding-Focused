...
tags: ["antigravity", "c:", "database", "decision", "delete", "design", "foreign", "frontend", "gemini", "key", "<YOUR_USERNAME>", "normalization", "primary", "principles", "relationship", "schema", "selection", "strategy", "timestamp", "types"]
tier: 3
risk: "medium"
