---
name: "mcp-builder-ms"
tags: ["antigravity", "builder", "c:", "deep", "deep-tech", "development", "ecosystem", "frontend", "gemini", "guide", "<YOUR_USERNAME>", "mcp", "microsoft", "ms", "overview", "server", "servers", "tech", "types", "use"]
tier: 2
risk: "medium"
estimated_tokens: 2876
tools_needed: ["docker", "git", "markdown", "mcp", "playwright", "sql"]
