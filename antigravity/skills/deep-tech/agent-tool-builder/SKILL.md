...
tags: ["agent", "antigravity", "builder", "c:", "capabilities", "deep", "deep-tech", "design", "error", "examples", "frontend", "gemini", "handling", "input", "<YOUR_USERNAME>", "patterns", "schema", "tech", "tool", "users"]
tier: 3
risk: "medium"
