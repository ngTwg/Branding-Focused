...
tags: ["antigravity", "backend", "best", "c:", "concrete", "contained", "contributing", "error", "examples", "first", "for", "frontend", "gemini", "guidelines", "impact", "key", "<YOUR_USERNAME>", "patterns", "postgres", "practices"]
tier: 2
risk: "medium"
