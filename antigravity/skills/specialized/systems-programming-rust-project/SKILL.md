...
tags: ["antigravity", "c:", "context", "frontend", "gemini", "instructions", "<YOUR_USERNAME>", "not", "programming", "project", "requirements", "rust", "scaffolding", "skill", "specialized", "systems", "this", "use", "users", "when"]
tier: 3
risk: "medium"
