...
tags: ["and", "antigravity", "automation", "c:", "core", "frontend", "gemini", "<YOUR_USERNAME>", "mcp", "photo", "post", "prerequisites", "publish", "rube", "setup", "specialized", "tiktok", "upload", "users", "via"]
tier: 3
risk: "critical"
