...
tags: ["antigravity", "backend", "c:", "configuration", "contents", "dev", "directly", "env", "frontend", "gemini", "guidelines", "<YOUR_USERNAME>", "management", "never", "overview", "pattern", "process", "resources", "rule", "specialized"]
tier: 2
risk: "medium"
