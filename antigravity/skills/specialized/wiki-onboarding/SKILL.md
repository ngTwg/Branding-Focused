...
tags: ["antigravity", "c:", "detection", "frontend", "gemini", "generator", "guide", "language", "<YOUR_USERNAME>", "level", "onboarding", "principal", "required", "rules", "sections", "specialized", "use", "users", "when", "wiki"]
tier: 2
risk: "medium"
