...
tags: ["and", "antigravity", "automation", "c:", "core", "create", "crm", "frontend", "gemini", "<YOUR_USERNAME>", "mcp", "prerequisites", "records", "retrieve", "rube", "search", "setup", "specialized", "users", "via"]
tier: 2
risk: "critical"
