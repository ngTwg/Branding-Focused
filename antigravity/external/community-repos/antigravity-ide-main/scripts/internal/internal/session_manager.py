...
@description Manages agent session persistence and context synthesis.
"""
...
def log_error(error, context):
    ...
    entry = f"""
## [{timestamp}] - Session-Manager Script Failure

- **Type**: Runtime
- **Severity**: Low
- **File**: \`.agent/scripts/internal/session_manager.py\`
...
- **Error Message**: 
  ...
  \`\`\`
- **Fix Applied**: N/A
- **Prevention**: Check filesystem availability and JSON integrity
