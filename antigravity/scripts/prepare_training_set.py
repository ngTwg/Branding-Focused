...
EVENT_LOG = Path(r"C:\Users\lengo\.gemini\antigravity\agent_flow_events.jsonl")
OUTPUT_JSONL = Path(r"C:\Users\lengo\.gemini\antigravity\scripts\antigravity_training_set.jsonl")
