...
- **Rule 3: Cross-Agent Rule Injection:** Tự động đồng bộ `GEMINI.md` vào `KIRO.md` hoặc `.kiro/steering/` để duy trì tính nhất quán về "nhận thức" giữa các môi trường làm việc.
