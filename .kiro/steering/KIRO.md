...
Trước mọi task → đọc MASTER ROUTER tại `C:/Users/<YOUR_USERNAME>/.gemini/antigravity/skills/MASTER_ROUTER.md`, phân tích Tags → Tier → load đúng skill từ ~1,999 skills đã merge.
...
### RULE 12: MINIMAL FILE CREATION ⭐ NEW
```
ĐỪNG TẠO FILE KHÔNG CẦN THIẾT:
1. CHỈ tạo file khi:
   - Core content (skills, code, config)
   - User yêu cầu cụ thể
   - Cần persist data lâu dài
   
2. KHÔNG tạo file khi:
   - Có thể trình bày trực tiếp trong response
   - Temporary reports/summaries
   - Documentation có thể inline
   - "Hở tí là tạo file"
   
3. ƯU TIÊN:
   - Trả lời trực tiếp trong chat
   - Inline documentation
   - Update existing files thay vì tạo mới
   - Hỏi user trước khi tạo file mới

NGUYÊN TẮC: "Trình bày được thì trình bày ra luôn, đừng tạo file"
```
