...
**Khi nào dùng:** Tasks >30 phút, Multi-phase projects, Complex refactoring, System migrations  
**Khi nào KHÔNG cần:** Simple fixes (<10 phút), Single-file changes, Quick tests

---

### RULE 6: EXTERNAL SKILL INTEGRATION (Tích hợp Skills Ngoài — sickn33 Layer)
...
- sickn33 là EXTERNAL LAYER — bổ sung, không thay thế (~1,324 skills, 38 bundles)
- Cài đặt: `antigravity/scripts/hybrid-install.ps1` | Bundles: `antigravity/scripts/activate-bundle.ps1`

**Khi nào dùng sickn33:** #seo, #stripe, #vercel, #azure, #docker, #k8s, #flutter, #rust, #terraform  
**Khi nào KHÔNG dùng:** Task liên quan CONSTITUTION, loki-mode, systematic-debugging
