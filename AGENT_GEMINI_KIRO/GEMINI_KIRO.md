...
#  GEMINI_KIRO_EXPANDED.md — MỞ RỘNG TOÀN DIỆN & NÂNG CẤP SÂU
*(Phần mở rộng bổ sung cho GEMINI_KIRO.md — merge toàn bộ vào file gốc)*

> **Phiên bản:** 2.0-EXPANDED
> **Ngày tạo:** 2026-03-24
> **Bổ sung cho:** GEMINI_KIRO.md (tổng hợp)
...
- **Self-Audit**: Agent định kỳ tự kiểm tra log hành động của chính mình để đảm bảo tuân thủ GEMINI_KIRO.md.
...
- **Rule 3: Cross-Model Validation:** Dùng Claude code -> GEMINI_KIRO review; giảm điểm mù của một mô hình.
